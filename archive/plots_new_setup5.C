#include "tile_plot_new_setup5.h"
//files for 2 cm steps only
//const char* files[]={"FLCM_01_02_03_2_stabConv.root","FLCM_04_05_06_2_2_stabConv.root","FLCM_07_08_09_2_1_stabConv.root"};
const char* files[]={"FACL_4p21_5_2_stabConv.root"};
float C[2];
...
void plots_new_setup2(){
	...
	*/
	...
	gPad->SetLeftMargin(0.15);
	gPad->SetBottomMargin(0.2);
	gr_sum->GetYaxis()->SetRangeUser(0,20000);
