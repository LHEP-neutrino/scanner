//THis is used to do cuts on the performance as only parts of the area has a tile
#include "tile_plot_new_setup2_RnD.h"

//for single once
const char* files[]={"Fret_6p_V1_1_stabConv.root","Fret_6p_V2_1_stabConv.root","Fret_6p_V3_1_stabConv.root",\
	"Fret_3p_V1_1_stabConv.root","Fret_3p_V2_1_stabConv.root",\
	"Fret_0p_V1_1_stabConv.root","Fret_0p_V2_1_stabConv.root","Fret_0p_foil_w_tpbdichroic_1_stabConv.root"};//\
	"FACL_4p21_2_8_stabConv.root","FACL_4p01_2_1_stabConv.root","FACL_4p04_2_1_stabConv.root","FACL_4p02_2_1_stabConv.root",\
...
"FACL_4p20_2_1_stabConv.root","FACL_4p16_2_1_stabConv.root","FACL_4p29_2_2_stabConv.root"}; //without foil
//const char* files[]={"Fret_0p_V2_1_stabConv.root"};
...
void plots_new_setup2_RnD(){
	...
	TString strFullpath = TString("/home/lhep/ArCLight_3DScan/scan_ACLFSD_1/scan_plots_new_setup2_RnD/");
	...
	*/
	...
	ofstream myfile;
	myfile.open("sum_new_setup2_RnD.txt");
	...
	gPad->SetLeftMargin(0.15);
	gPad->SetBottomMargin(0.2);
	gr_sum->GetYaxis()->SetRangeUser(0,4000); //ACL 25000; LCM 50000; s90: 10000
