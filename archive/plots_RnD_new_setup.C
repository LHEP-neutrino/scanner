#include "tile_plot_RnD_new_setup.h"
//const char* files[]={"ZEOFret_one_single_2_stabConv.root"};
//const char* files[]={"FretLight_modX_no_foil_2_stabConv.root","FretLight_modX_no_foil_3_stabConv.root","FretLight_modX_no_foil_4_stabConv.root","FretLight_modX_no_foil_5_stabConv.root","FretLight_modX_wi_foil_1_stabConv.root"};
const char* files[]={"FretLight_modX_no_foil_5_stabConv.root","FretLight_modX_wi_foil_2_stabConv.root"};
float C[2];
...
void plots_RnD_new_setup(){
	...
	TString strFullpath = TString("/home/lhep/ArCLight_3DScan/scan_ACLFSD_1/scan_plots_RnD_new_setup/");
	...
	*/
	...
	ofstream myfile;
	myfile.open("sum_RnD_new_setup.txt");
	...
	gr_sum->SetTitle("Sum of the total light per tile;;total photons");
	...
	gPad->SetLeftMargin(0.15);
	gPad->SetBottomMargin(0.2);
	//gr_sum->GetYaxis()->SetRangeUser(0,50000);
