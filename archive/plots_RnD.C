#include "tile_plot_RnD.h"
//const char* files[]={"ZEOFret_one_single_2_stabConv.root"};
const char* files[]={"SiPN_sideways_1_stabConv.root"};
float C[2];
...
void plots_RnD(){
	...
	TString strFullpath = TString("/home/daq/ArCLight_3DScan/scan_ACL3_series/scan_plots_RnD/");
