...
float tilesizex = 300;
float tilesizey = 500;
float n_y = 10;//100;//33;//25;//number of measurements for y direction; high res (5mm): 100; 2cm steps: 25; 1cm steps: 50
float y_max = tilesizey;//length in y direction
float n_x = 6;//60;//20//15;//number of measurements for x direction High res (5mm): 60; 2cm steps: 15; 1cm steps: 30
