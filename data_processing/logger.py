...
# Get the script name 
script_name = 'data_processing_logger'  
...
data_processing_dir = os.path.dirname(current_file_path)


# Define the log folder inside the module directory
log_dir = os.path.join("../", data_processing_dir, "log")
log_file_name = "data_processing.log"
