#include "tile_plot_ACL3.h"
const char* files[]={"tile_3_7_2_stabConv.root","tile_3_16_6_stabConv.root","tile_3_8_4_stabConv.root","tile_3_17_5_stabConv.root","tile_3_13_4_stabConv.root","tile_all_sides_stabConv.root","tile_3_6_6_stabConv.root"};
float C[2];
...
float *getMean(const char* rootfilename){
	...
	mon_drift_s->cd();
	t_out->Draw("LY_tot_mon_nph:Entry$>>h_temp2","z<0&&Entry$!=0");
...
void plots_ACL3(){
	...
	TString strFullpath = TString("/home/daq/ArCLight_3DScan/scan_ACL3_series/scan_plots_ACL3/");
	...
	gPad->SetLeftMargin(0.15);
	gPad->SetBottomMargin(0.2);
	gr_sum->GetYaxis()->SetRangeUser(0,100000);
	gr_sum->Draw("ap");
	//C_sum->cd(2);
	//pt->Draw();
