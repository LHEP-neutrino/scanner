...
# In the form of a class, such that the connection stay open and many readout can be done efficiently,
# e.g. for a temperature mapping during a scan. The class can be used in a context manager to ensure proper cleanup of the connection, and it can be easily integrated into the existing codebase for the scanner control.
